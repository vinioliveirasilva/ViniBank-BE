...
class SuccessScreen : SdUiScreen {
        ...
        components = listOf(
            component(
                ...
                properties = listOf(
                    ...
                    property(name = "paddingHorizontal", value = "20"),
                ...
                components = listOf(
                    component(
                        type = "text",
                        properties = listOf(
                            property(name = "text", value = "Conta Criada com Sucesso"),
                        ),
                    )
                )
            ),
            component(
                ...
                properties = listOf(
                    property(name = "paddingHorizontal", value = "20"),
                    property(name = "horizontalFillType", value = "Max"),
                    property(name = "verticalFillType", value = "Max"),
