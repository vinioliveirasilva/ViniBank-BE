        ...
        components = listOf(
            ScreenUtil.component(
                ...
                properties = listOf(
                    ...
                    ScreenUtil.property(name = "paddingHorizontal", value = "20"),
                    ScreenUtil.property(name = "textAlign", value = "Center"),
                ),
                components = listOf(
                    ScreenUtil.component(
                        type = "text",
                        properties = listOf(
                            ScreenUtil.property(name = "text", value = "Conta Criada com Sucesso"),
                        ),
                    )
                )
            ),
            ScreenUtil.component(
                ...
                properties = listOf(
                    ScreenUtil.property(name = "paddingHorizontal", value = "20"),
                    ScreenUtil.property(name = "horizontalFillType", value = "Max"),
                    ScreenUtil.property(name = "verticalFillType", value = "Max"),
                        ...
                        actions = listOf(
                            ScreenUtil.action(
                                ...
                                data = ScreenUtil.jsonObject(
                                    "screenData" to request.screenData?.let {
